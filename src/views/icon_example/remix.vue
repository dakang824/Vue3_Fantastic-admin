<template>
    <div>
        ...
        <page-main v-for="(category, key) in icons" :key="key" :title="key" collaspe height="200px" style="padding-bottom: 5px;">
            <el-row :gutter="20">
                <el-col v-for="(icon, iconKey) in category" :key="iconKey" :xs="6" :sm="8" :md="3" :lg="2">
                    <el-card shadow="hover" @click="showInfo(key == 'Editor' ? `ri-${iconKey}` : `ri-${iconKey}-${style}`)">
        ...
        <el-dialog v-model="dialog.visible" :show-close="false" width="500px">
            <el-row type="flex">
            ...
            <div class="more-info">
                <el-divider content-position="left">结合 Element Plus 使用场景</el-divider>
